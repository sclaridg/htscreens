...
biomarker_type_curated <-
  ...
  ifelse(g2p$Feature.Names == "KRAS G12G" | g2p$Feature.Names == "KRAS G13G", "synonymous",
...
fusions$ <- gsub(" .*", "", fusions$RightGene)
```
...
# Testing
test_ccle <- ccle_ptmuts %>% count(Gene, Drug)
