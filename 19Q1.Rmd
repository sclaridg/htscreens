...
ccle_signif_gene <- WilcoxonTestDF(dataframe = ccle_ptmuts, grouping = "Gene", outfile = "./data_munging/rds/ccle_signif_g2p_gene.rds")
ccle_signif_lineage <- WilcoxonTestDF(dataframe = ccle_ptmuts, grouping = c("Gene", "Primary.Disease"), outfile = "./data_munging/rds/ccle_signif_g2p_lineage.rds")
```
