...
tcga_hist_converter <- read.delim("./data_munging/TCGA/ge_cancer_map_20190403.csv", sep = ",")
tcga_hist_converter$Cell_line <- toupper(gsub("-", "", tcga_hist_converter$Cell_line))
tcga_hist_converter %>% count(TCGA_classification)
```
