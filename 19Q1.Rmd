...
MakeCorrHeatmap <- function(drug_cor_res, row_names, col_title, color, legend_title) {
...
# saveRDS(g2p_corr_all, "./data_munging/rds/g2p_dgl_corr.rds")
g2p_corr_all <- readRDS("./data_munging/rds/g2p_dgl_corr.rds")
