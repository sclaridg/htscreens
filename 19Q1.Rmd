...
# ge_melt_19Q1 <- readRDS("./data_munging/19Q1/ge_melt_19Q1.rds")
...
saveRDS(ccle_data, "./data_munging/19Q1/ccle_data_19Q1_g2pgenes.rds", compress = "xz")
...
saveRDS(ctrp_data, "./data_munging/19Q1/ctrp_data_19Q1_g2pgenes.rds", compress = "xz")
...
saveRDS(gdsc_data, "./data_munging/19Q1/gdsc_data_19Q1_g2pgenes.rds", compress = "xz")
```

### Filter drug data

```{r, eval=FALSE}
ccle_data <- readRDS("./data_munging/19Q1/ccle_data_19Q1_g2pgenes.rds")
...
saveRDS(ccle_data_ptmuts, "./data_munging/19Q1/ccle_data_19Q1_g2pgenes_ptmuts.rds", compress = "xz")

ctrp_data <- readRDS("./data_munging/19Q1/ctrp_data_19Q1_g2pgenes.rds")
...
saveRDS(ctrp_data_ptmuts, "./data_munging/19Q1/ctrp_data_19Q1_g2pgenes_ptmuts.rds", compress = "xz")

gdsc_data <- readRDS("./data_munging/19Q1/gdsc_data_19Q1_g2pgenes.rds")
...
saveRDS(gdsc_data_ptmuts, "./data_munging/19Q1/gdsc_data_19Q1_g2pgenes_ptmuts.rds", compress = "xz")
```
...
ctrp_data <- readRDS("./data_munging/19Q1/ctrp_data_19Q1_g2pgenes.rds")
gdsc_data <- readRDS("./data_munging/19Q1/gdsc_data_19Q1_g2pgenes.rds")
ccle_data_ptmuts <- readRDS("./data_munging/19Q1/ccle_data_19Q1_g2pgenes_ptmuts.rds")
ctrp_data_ptmuts <- readRDS("./data_munging/19Q1/ctrp_data_19Q1_g2pgenes_ptmuts.rds")
gdsc_data_ptmuts <- readRDS("./data_munging/19Q1/gdsc_data_19Q1_g2pgenes_ptmuts.rds")
...
ctrp4harm <- dcast(ctrp4harm_long, source + source_ccl_name + source_histology + sample_id ~ compound_name, value.var = "AUC", fill = 0)
```
