...
lineage_converter <- unique(select(lineage_converter, grouped_general_doid, group_general_lineage_name))
...
crispr_ptmuts$Gene <- factor(crispr_ptmuts$Gene)
...
drug_hists <- rbind(ccle_hists, ctrp_hists, gdsc_hists)
