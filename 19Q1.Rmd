...
# write.csv.gz(auc_all_ccls, file = "./data_munging/pozdeyev2016/merged_auc_v20190327.3.csv.gz", row.names = FALSE, na = "NA")
...
cn_seg <- merge(ccl_histologies, cn_seg, by = "Broad_ID", all.y = TRUE)
cn_seg_lung <- filter(cn_seg, Histology == "lung")
```
...
# Denise's GCN dataframes (Deprected)
