...
saveRDS(maf_df, "./data_munging/rds/maf_df_19Q1.rds", compress = "xz")
```
...
saveRDS(cn_melt, "./data_munging/rds/cn_melt_19Q1.rds", compress = "xz")
```
...
```{r, eval=FALSE}
# ge_18Q3 <- read.delim("./../htscreens_giant_files/CCLE_depMap_19Q1_TPM_20190305.csv.gz", skip = 2, header = TRUE, sep = "\t", check.names = FALSE)
# # Edit columns
# ge_18Q3$Name <- NULL
...
# Melt
ge_melt_19Q1_all <- melt(ge_19Q1, id.vars = "Broad_ID", measure.vars = colnames(ge_19Q1)[2:ncol(ge_19Q1)], variable.name = "Hugo_Symbol", value.name = "TPM")
# ge_melt_19Q1 <- unique(ge_melt_19Q1_all)
saveRDS(ge_melt_19Q1, "./data_munging/rds/ge_melt_19Q1.rds", compress = "xz")
```
...
unique(g2p_filt$group_generals_lineage_name)
...
```{r, eval=FALSE}
cn_melt <- readRDS("./data_munging/rds/cn_melt_19Q1.rds")
ge_melt_18Q3 <- readRDS("./../htscreens_giant_files/ge_melt_18Q3.rds")
# ge_melt_19Q1 <- readRDS("./data_munging/rds/ge_melt_19Q1.rds")

# maf_filt_dan <- filter(maf_df, Hugo_Symbol %in% g2p_genes)
# write.table(maf_filt_dan, file = "~/Desktop/maf_filt_dan_19Q1_2018112.csv", quote = FALSE, sep = ",", row.names = FALSE)
```
...
```{r}
maf_df <- readRDS("./data_munging/rds/maf_df_19Q1.rds")
...
# ge_filt_19Q1 <- filter(ge_melt_19Q1, Hugo_Symbol %in% g2p_genes)
