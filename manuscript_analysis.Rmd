...
# in GDSC only
drug_venn_mut[[7]]$label  <- paste(sort(setdiff(setdiff(gdsc_dgs, ctrp_dgs), ccle_dgs)), collapse = "\n")
# in GDSC and CTRP only
drug_venn_mut[[8]]$label <- paste(intersect(gdsc_dgs, ctrp_dgs), collapse = "\n")
# in CTRP only
drug_venn_mut[[9]]$label <- paste(sort(setdiff(setdiff(ctrp_dgs, gdsc_dgs), ccle_dgs)), collapse = "\n")
# in CTRP and CCLE only
drug_venn_mut[[10]]$label <- intersect(ccle_dgs, ctrp_dgs)
