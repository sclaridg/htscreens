...
```{r}
test <- adj_signif(ccle_signif_grid_lineage, alpha = 0.05)
length(unique(test))
```
...
```{r}
test <- p.adjust(ccle_signif_g2p$p, method = "BH")
```
...
png("./plots/manuscript/crispr_venn.png")
grid.newpage()
...
png("./plots/manuscript/drugscreen_venn.png")
grid.newpage()
grid.draw(drug_venn)
dev.off()
```
...
g2p_ks_res_plot_spearman <- ggplot(data = filter(g2p_corr_4plot, Correlation_Method == "Spearman")) +
  ...
  scale_color_manual(values = c("CCLE" = "springgreen4", "CTRP" = "steelblue4", "GDSC" = "turquoise4", "CCLE" = "springgreen4", "CTRP" = "steelblue4", "GDSC" = "turquoise4")) +
  coord_cartesian(ylim = c(-1, 1)) +
...
# ggsave("./plots/manuscript/g2p_spearman_ks_res_plot.png", g2p_ks_res_plot_spearman, device = "png", dpi = 450, width = 12, height = 6, units = "in")
```
