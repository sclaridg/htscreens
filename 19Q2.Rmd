...
**1/10/20: Restrict datasets to heatmap drug-genes and run KS tests.**
```{r}
ks.test(filter(ccle_signif_g2p_dg, InG2P == "Yes")$p, filter(ccle_signif_g2p_dg, InG2P == "No")$p)
ks.test(filter(ctrp_signif_g2p_dg, InG2P == "Yes")$p, filter(ctrp_signif_g2p_dg, InG2P == "No")$p)
ks.test(filter(gdsc_signif_g2p_dg, InG2P == "Yes")$p, filter(gdsc_signif_g2p_dg, InG2P == "No")$p)

ks.test(filter(ccle_signif_dgl, InG2P == "Yes")$p, filter(ccle_signif_dgl, InG2P == "No")$p)
ks.test(filter(ctrp_signif_dgl, InG2P == "Yes")$p, filter(ctrp_signif_dgl, InG2P == "No")$p)
ks.test(filter(gdsc_signif_dgl, InG2P == "Yes")$p, filter(gdsc_signif_dgl, InG2P == "No")$p)

ks.test(filter(ccle_signif_prot, InG2P == "Yes")$p, filter(ccle_signif_prot, InG2P == "No")$p)
ks.test(filter(ctrp_signif_prot, InG2P == "Yes")$p, filter(ctrp_signif_prot, InG2P == "No")$p)
ks.test(filter(gdsc_signif_prot, InG2P == "Yes")$p, filter(gdsc_signif_prot, InG2P == "No")$p)

ks.test(filter(ccle_signif_prot_lin, InG2P == "Yes")$p, filter(ccle_signif_prot_lin, InG2P == "No")$p)
ks.test(filter(ctrp_signif_prot_lin, InG2P == "Yes")$p, filter(ctrp_signif_prot_lin, InG2P == "No")$p)
ks.test(filter(gdsc_signif_prot_lin, InG2P == "Yes")$p, filter(gdsc_signif_prot_lin, InG2P == "No")$p)

ks.test(filter(cn_cor, Dataset == "CCLE" & InG2P == "Yes")$CN_r, filter(cn_cor, Dataset == "CCLE" & InG2P == "No")$CN_p)
ks.test(filter(cn_cor, Dataset == "CTRP" & InG2P == "Yes")$CN_r, filter(cn_cor, Dataset == "CTRP" & InG2P == "No")$CN_p)
ks.test(filter(cn_cor, Dataset == "GDSC" & InG2P == "Yes")$CN_r, filter(cn_cor, Dataset == "GDSC" & InG2P == "No")$CN_p)

ks.test(filter(ge_cor, Dataset == "CCLE" & InG2P == "Yes")$GE_p, filter(ge_cor, Dataset == "CCLE" & InG2P == "No")$GE_p)
ks.test(filter(ge_cor, Dataset == "CTRP" & InG2P == "Yes")$GE_p, filter(ge_cor, Dataset == "CTRP" & InG2P == "No")$GE_p)
ks.test(filter(ge_cor, Dataset == "GDSC" & InG2P == "Yes")$GE_p, filter(ge_cor, Dataset == "GDSC" & InG2P == "No")$GE_p)

ks.test(filter(cn_cor_lin, Dataset == "CCLE" & InG2P == "Yes")$CN_r, filter(cn_cor_lin, Dataset == "CCLE" & InG2P == "No")$CN_p)
ks.test(filter(cn_cor_lin, Dataset == "CTRP" & InG2P == "Yes")$CN_r, filter(cn_cor_lin, Dataset == "CTRP" & InG2P == "No")$CN_p)
ks.test(filter(cn_cor_lin, Dataset == "GDSC" & InG2P == "Yes")$CN_r, filter(cn_cor_lin, Dataset == "GDSC" & InG2P == "No")$CN_p)

ks.test(filter(ge_cor_lin, Dataset == "CCLE" & InG2P == "Yes")$GE_p, filter(ge_cor_lin, Dataset == "CCLE" & InG2P == "No")$GE_p)
ks.test(filter(ge_cor_lin, Dataset == "CTRP" & InG2P == "Yes")$GE_p, filter(ge_cor_lin, Dataset == "CTRP" & InG2P == "No")$GE_p)
ks.test(filter(ge_cor_lin, Dataset == "GDSC" & InG2P == "Yes")$GE_p, filter(ge_cor_lin, Dataset == "GDSC" & InG2P == "No")$GE_p)
```
...
mut_genes <- union(union(filter(ccle_signif_g2p_dg, InG2P == "Yes")$Gene, filter(ctrp_signif_g2p_dg, InG2P == "Yes")$Gene), filter(gdsc_signif_g2p_dg, InG2P == "Yes")$Gene)
mut_drugs <- union(union(filter(ccle_signif_g2p_dg, InG2P == "Yes")$Drug, filter(ctrp_signif_g2p_dg, InG2P == "Yes")$Drug), filter(gdsc_signif_g2p_dg, InG2P == "Yes")$Drug)

ht_ccle2 <- MakeWilcoxonHeatmap(signif_df = filter(ccle_signif_g2p_dg, Drug %in% mut_drugs & Gene %in% mut_genes), feature = "mutation", legend_title = "CCLE -log10(p-value)", legend_breaks = seq(0, 12, by = 3), row_names = TRUE, color = "darkgreen", col_title = "", row_title_txt = "Genes", radius = 0.023)
ht_ctrp2 <- MakeWilcoxonHeatmap(signif_df = filter(ctrp_signif_g2p_dg, Drug %in% mut_drugs & Gene %in% mut_genes), feature = "mutation", legend_title = "CTRP -log10(p-value)", legend_breaks = seq(0, 18, by = 3), row_names = FALSE, color = "steelblue4", col_title = "Drugs", row_title_txt = "Genes", radius = 0.008)
ht_gdsc2 <- MakeWilcoxonHeatmap(signif_df = filter(gdsc_signif_g2p_dg, Drug %in% mut_drugs & Gene %in% mut_genes), feature = "mutation", legend_title = "GDSC -log10(p-value)", legend_breaks = seq(0, 5, by = 1), row_names = FALSE, color = "turquoise4", col_title = "", row_title_txt = "Genes", radius = 0.011)
...
prot_drugs <- prot_drugs[!(prot_drugs %in% c("cabozantinib", "vandetinib"))]

ht_ccle2 <- MakeWilcoxonHeatmap(signif_df = filter(ccle_signif_prot_4plot, Drug %in% prot_drugs), feature = "protein changes", legend_title = "CCLE -log10(p-value)", legend_breaks = seq(0, 5, by = 1), row_names = TRUE, color = "darkgreen", col_title = "", row_title_txt = "Gene:Protein Change", na_color = "black", radius = 0.021)
...
ht_gdsc2 <- MakeWilcoxonHeatmap(signif_df = filter(gdsc_signif_prot_4plot, Drug %in% prot_drugs), feature = "protein changes", legend_title = "GDSC -log10(p-value)", legend_breaks = seq(0, 3, by = 1), row_names = FALSE, color = "turquoise4", col_title = "", row_title_txt = "Gene:Protein Change", na_color = "black", radius = 0.0125)
...
# ccle_prot_annot <- select(filter(ccle_prot, Drug_Gene %in% ccle_mut_lin_filt$Drug_Gene & Change_Status == "Yes"), Drug_Gene, Protein_Change, DepMap_ID) 
# test <- merge(ccle_mut_lin_filt, ccle_prot_annot, by = c("DepMap_ID", "Drug_Gene"), all.x = TRUE)
```
...
png(filename = "./plots/manuscript_final/drug_lin__pancancer.png", width = 18, height = 8, units = "in", res = 500)
grid.arrange(layout_matrix = lay, grobs = gs_cn_ge)
dev.off()
```
