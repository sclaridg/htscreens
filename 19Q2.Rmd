...
ccl_meta <- merge(ccl_meta, ccl_histologies, by = c("Cell_line", "CCLE_histology", "DepMap_ID"), all = TRUE)
...
write.csv(ccl_meta, "./data_munging/19Q2/sample_info_edit_20190717.csv")
```
...
biomarker_type_curated <- 
  ...
  ifelse(!is.na(str_match(string = toupper(g2p$Feature.Names), pattern = "[A-Z0-9|A-Z]+-[A-Z0-9|A-Z]+|FUSION|POSITIVE")[,1]) & is.na(str_match(string = g2p$Feature.Names, pattern = "[0-9]+-[0-9]+")) | g2p$biomarker_type == "fusion" | g2p$biomarker_type == "rearrange", "Fusion",
