...
ccle_mut_ht_dat <- filter(ccle_signif_g2p_dg, Drug %in% mut_drugs & Gene %in% mut_genes)
ks.test(filter(ccle_mut_ht_dat, InG2P == "Yes")$p, filter(ccle_mut_ht_dat, InG2P == "No")$p)

ctrp_mut_ht_dat <- filter(ctrp_signif_g2p_dg, Drug %in% mut_drugs & Gene %in% mut_genes)
ks.test(filter(ctrp_mut_ht_dat, InG2P == "Yes")$p, filter(ctrp_mut_ht_dat, InG2P == "No")$p)

gdsc_mut_ht_dat <- filter(gdsc_signif_g2p_dg, Drug %in% mut_drugs & Gene %in% mut_genes)
ks.test(filter(gdsc_mut_ht_dat, InG2P == "Yes")$p, filter(gdsc_mut_ht_dat, InG2P == "No")$p)
```
...
ccle_prot_ht_data <- filter(ccle_signif_prot_4plot, Drug %in% prot_drugs)
ks.test(filter(ccle_prot_ht_data, InG2P == "Yes")$p, filter(ccle_prot_ht_data, InG2P == "No")$p)

ctrp_prot_ht_data <- filter(ctrp_signif_prot_4plot, Drug %in% prot_drugs)
ks.test(filter(ctrp_prot_ht_data, InG2P == "Yes")$p, filter(ctrp_prot_ht_data, InG2P == "No")$p)

gdsc_prot_ht_data <- filter(gdsc_signif_prot_4plot, Drug %in% prot_drugs)
ks.test(filter(gdsc_prot_ht_data, InG2P == "Yes")$p, filter(gdsc_prot_ht_data, InG2P == "No")$p)
```
...
ks.test(filter(ccle_signif_dgl, InG2P == "Yes")$p, filter(ccle_signif_dgl, InG2P == "No")$p)$p.value
