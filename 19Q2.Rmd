...
ccle <- MergeOmicsG2P(database = "CCLE", maf_df = maf_df, ge_df = ge_melt, cn_df = cn_melt, gene_list = g2p_genes, outfile = "./../htscreens_giant_files/ccle_data_19Q2.rds")
...
gdsc <- MergeOmicsG2P(database = "GDSC", maf_df = maf_df, ge_df = ge_melt, cn_df = cn_melt, gene_list = g2p_genes, outfile = "./../htscreens_giant_files/gdsc_data_19Q2.rds")
...
ccle <- readRDS("./data_munging/rds/ccle_data_19Q2_g2pgenes_ptmuts.rds") %>% drop_na(Drug)
ctrp <- readRDS("./data_munging/rds/ctrp_data_19Q2_g2pgenes_ptmuts.rds") %>% drop_na(Drug)
gdsc <- readRDS("./data_munging/rds/gdsc_data_19Q2_g2pgenes_ptmuts.rds") %>% drop_na(Drug)
