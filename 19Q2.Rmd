...
crispr_prot <- readRDS("./data_munging/19Q2/crispr_protein_changes.rds")
```
...
Testing:
```{r}
dataframe <- crispr_prot
grouping <- c("Gene_Protein_Change", "Drug", "Drug_Gene_Protein_Change")
...
**10/9 STOPPED HERE BEFORE REALIZING I NEEDED TO RUN CRISPR PROT AND FUS WILCOXON TESTS**
