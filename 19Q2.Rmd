...
```{r}
MakeWilcoxonHeatmap <- function(signif_df, feature, row_names, col_title, color, legend_title, row_title_txt) {
  if(!is.na(str_match(string = tolower(feature), pattern = "mut"))) {
    signif_grid <- dcast(signif_df, Gene ~ Drug, value.var = "p", fun.aggregate = mean, fill = 0) %>% `rownames<-`(.[,1]) %>% select(-Gene)
  ...
  if(!is.na(str_match(string = tolower(feature), pattern = "fus"))) {
    signif_grid <- dcast(signif_df, FusionPair ~ Drug, value.var = "p", fun.aggregate = mean, fill = 0) %>% `rownames<-`(.[,1]) %>% select(-FusionPair)
  ...
  ht <- Heatmap(signif_grid,
                ...
                cell_fun = function(j, i, x, y, width, height, fill) {
                  ...
                  #   grid.circle(x = x, y = y, r = min(unit.c(width, height))*0.45, gp = gpar(fill = "transparent", col = "black"))
                  # }
                }
                )
  return(ht)
...
ht_ccle <- MakeWilcoxonHeatmap(signif_df = filter(ccle_signif_g2p_dg, Gene %in% unique(g2p_mut$Gene)), feature = "mutation", legend_title = "P-value", row_names = TRUE, color = "darkgreen", col_title = "Drugs", row_title_txt = "Genes")
...
ht_ctrp <- MakeWilcoxonHeatmap(signif_df = filter(ctrp_signif_g2p_dg, Gene %in% unique(g2p_mut$Gene)), feature = "mutation", legend_title = "P-value", row_names = TRUE, color = "steelblue4", col_title = "Drugs", row_title_txt = "Genes")
...
ht_gdsc <- MakeWilcoxonHeatmap(signif_df = filter(gdsc_signif_g2p_dg, Gene %in% unique(g2p_mut$Gene)), feature = "mutation", legend_title = "P-value", row_names = TRUE, color = "turquoise4", col_title = "Drugs", row_title_txt = "Genes")
...
ht_ccle2 <- MakeWilcoxonHeatmap(signif_df = filter(ccle_signif_g2p_dg, Gene %in% unique(g2p_mut$Gene)), feature = "mutation", legend_title = "CCLE p-value                                                                               ", row_names = TRUE, color = "darkgreen", col_title = "", row_title_txt = "Genes")
ht_ctrp2 <- MakeWilcoxonHeatmap(signif_df = filter(ctrp_signif_g2p_dg, Gene %in% unique(g2p_mut$Gene)), feature = "mutation", legend_title = "CTRP p-value                                                                              ", row_names = FALSE, color = "steelblue4", col_title = "Drugs", row_title_txt = "Genes")
ht_gdsc2 <- MakeWilcoxonHeatmap(signif_df = filter(gdsc_signif_g2p_dg, Gene %in% unique(g2p_mut$Gene)), feature = "mutation", legend_title = "GDSC p-value", row_names = FALSE, color = "turquoise4", col_title = "", row_title_txt = "Genes")
...
ht_ccle <- MakeWilcoxonHeatmap(signif_df = filter(ccle_signif_fus, Drug %in% g2p_drugs), feature = "fusion", legend_title = "P-value", row_names = TRUE, color = "darkgreen", col_title = "Drugs", row_title_txt = "Fusion Pairs")
png(filename = "./plots/manuscript/ccle_fus_heatmap.png", width = 2.5, height = 3, units = "in", res = 500)
draw(ht_ccle, heatmap_legend_side = "top")
dev.off()

ht_ctrp <- MakeWilcoxonHeatmap(signif_df = filter(ctrp_signif_fus, Drug %in% g2p_drugs), feature = "fusion", legend_title = "P-value", row_names = TRUE, color = "steelblue4", col_title = "Drugs", row_title_txt = "Fusion Pairs")
png(filename = "./plots/manuscript/ctrp_fus_heatmap.png", width = 6, height = 3, units = "in", res = 500)
draw(ht_ctrp, heatmap_legend_side = "top")
dev.off()

ht_gdsc <- MakeWilcoxonHeatmap(signif_df = filter(gdsc_signif_fus, Drug %in% g2p_drugs), feature = "fusion", legend_title = "P-value", row_names = TRUE, color = "turquoise4", col_title = "Drugs", row_title_txt = "Fusion Pairs")
png(filename = "./plots/manuscript/gdsc_fus_heatmap.png", width = 5, height = 3, units = "in", res = 500)
draw(ht_gdsc, heatmap_legend_side = "top")
dev.off()

ht_ccle2 <- MakeWilcoxonHeatmap(signif_df = filter(ccle_signif_fus, Drug %in% g2p_drugs), feature = "fusion", legend_title = "CCLE p-value                                                                               ", row_names = TRUE, color = "darkgreen", col_title = "", row_title_txt = "Fusion Pairs")
ht_ctrp2 <- MakeWilcoxonHeatmap(signif_df = filter(ctrp_signif_fus, Drug %in% g2p_drugs), feature = "fusion", legend_title = "CTRP p-value                                                                              ", row_names = FALSE, color = "steelblue4", col_title = "Drugs", row_title_txt = "Fusion Pairs")
ht_gdsc2 <- MakeWilcoxonHeatmap(signif_df = filter(gdsc_signif_fus, Drug %in% g2p_drugs), feature = "fusion", legend_title = "GDSC p-value", row_names = FALSE, color = "turquoise4", col_title = "", row_title_txt = "Fusion Pairs")
