...
ht_mut_grob <- grid.grabExpr(draw(ht_mut_list, gap = unit(0.25, "in"), heatmap_legend_side = "top"))
...
crispr_mut_filt_plot <- ggplot(data = crispr_mut_filt, aes(x = as.character(Mutation), y = Score) )+
  ...
  stat_compare_means(method = "wilcox", aes(label = paste0("p = ", ..p.format..)), label.x = 1.4) +
  labs(title = "CRISPR", x = "Mutation Status") +
...
ccle_mut_filt_plot <- ggplot(data = ccle_mut_filt, mapping = aes(x = as.character(Mutation), y = Score)) +
  ...
  stat_compare_means(method = "wilcox", aes(label = paste0("p = ", ..p.format..)), label.x = 1.4) +
  labs(title = "CCLE", x = "Mutation Status") +
  theme(legend.position = "none", axis.title.x = element_blank(),
...
ctrp_mut_filt_plot <- ggplot(data = ctrp_mut_filt, mapping = aes(x = as.character(Mutation), y = Score)) +
  ...
  stat_compare_means(method = "wilcox", aes(label = paste0("p = ", ..p.format..)), label.x = 1.4) +
  labs(title = "CTRP", x = "Mutation Status") +
  theme(legend.position = "none", axis.title.x = element_blank(),
...
gdsc_mut_filt_plot <- ggplot(data = gdsc_mut_filt, mapping = aes(x = as.character(Mutation), y = Score)) +
  ...
  stat_compare_means(method = "wilcox", aes(label = paste0("p = ", ..p.format..)), label.x = 1.4) +
  labs(title = "GDSC", x = "Mutation Status") +
  theme(legend.position = "none", axis.title.x = element_blank(),
...
png(filename = "./plots/manuscript_final/all_mutation_agnostic_boxplots.png", width = 15, height = 15, units = "in", res = 500)
...
ht_prot_grob <- grid.grabExpr(draw(ht_prot_list, gap = unit(0.25, "in"), heatmap_legend_side = "top"))
...
crispr_prot_filt_plot <- ggplot(data = crispr_prot_filt, aes(x = as.character(Change_Status), y = Score) )+
  ...
  stat_compare_means(method = "wilcox", aes(label = paste0("p = ", ..p.format..)), label.x = 1.4) +
  labs(title = "CRISPR", x = "Protein Change Status") +
  theme(legend.position = "none", axis.title.x = element_blank(),
        panel.background = element_rect(fill = "snow1", colour = "snow1", size = 0.5, linetype = "solid"),
        panel.grid.major = element_line(size = 0.5, linetype = 'solid', colour = "white"), 
        panel.grid.minor = element_line(size = 0.25, linetype = 'solid', colour = "white"))
...
ctrp_prot_filt_plot <- ggplot(data = ctrp_prot_filt, mapping = aes(x = as.character(Change_Status), y = Score)) +
  ...
  stat_compare_means(method = "wilcox", aes(label = paste0("p = ", ..p.format..)), label.x = 1.4) +
  labs(title = "CTRP", x = "Protein Change Status") +
  theme(legend.position = "none", axis.title.x = element_blank(),
        panel.background = element_rect(fill = "whitesmoke", colour = "whitesmoke", size = 0.5, linetype = "solid"),
        panel.grid.major = element_line(size = 0.5, linetype = 'solid', colour = "white"), 
        panel.grid.minor = element_line(size = 0.25, linetype = 'solid', colour = "white"))
...
gdsc_prot_filt_plot <- ggplot(data = gdsc_prot_filt, mapping = aes(x = as.character(Change_Status), y = Score)) +
  ...
  stat_compare_means(method = "wilcox", aes(label = paste0("p = ", ..p.format..)), label.x = 1.4) +
  labs(title = "GDSC", x = "Protein Change Status") +
  theme(legend.position = "none", axis.title.x = element_blank(),
        panel.background = element_rect(fill = "lightcyan", colour = "lightcyan", size = 0.5, linetype = "solid"),
        panel.grid.major = element_line(size = 0.5, linetype = 'solid', colour = "white"), 
        panel.grid.minor = element_line(size = 0.25, linetype = 'solid', colour = "white"))
...
png(filename = "./plots/manuscript_final/all_protein_change_agnostic_boxplots.png", width = 15, height = 15, units = "in", res = 500)
grid.arrange(layout_matrix = lay,
...
**1/3: Need to do CN and GE and lineage specific analyses**
