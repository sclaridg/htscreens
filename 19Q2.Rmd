...
crispr_fus <- merge(merge(crispr, crispr_fus_grid, by = "DepMap_ID", all = TRUE), fusions_filt, by = c("DepMap_ID", "FusionPair"), all = TRUE)
...
**10/15 FIX FUSION_STATUS COLUMN, ALL "NO"**
