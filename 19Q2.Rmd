...
fusions_filt <- unique(filter(fusions, FusionPair %in% unique(as.character(g2p_fus$FusionPair)))) %>% select(-c("Cell_line", "disease"))
...
saveRDS(crispr_fus, "./../htscreens_giant_files/crispr_fusions.rds", compress = "xz")
```
...
```{r, eval = TRUE}
crispr_fus <- readRDS("./../htscreens_giant_files/crispr_fusions.rds")
