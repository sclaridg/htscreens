...
# chm_scores_c1 <- t(t(rownames(chm_scores[row_order(chm_scores_draw)[[1]],])))
# chm_scores_c2 <- t(t(rownames(chm_scores[row_order(chm_scores_draw)[[2]],])))
# chm_scores_c3 <- t(t(rownames(chm_scores[row_order(chm_scores_draw)[[3]],])))
# chm_scores_c4 <- t(t(rownames(chm_scores[row_order(chm_scores_draw)[[4]],])))
...
pdf("./plots_18Q3/crispr_heatmap_all_cgc.pdf", width = 100, height = 100, paper = "special")
