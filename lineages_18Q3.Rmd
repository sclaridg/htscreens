...
wilcox_gene_plot <- ggplot(data = crispr_signif, aes(x = p.adj)) +
  geom_histogram(breaks = seq(0, 1, by = 0.025), fill = "darkslategray3", color = "black", alpha = 0.7) +
  scale_x_continuous(breaks = seq(0, 1, by = 0.05), labels = seq(0, 1, by = 0.05)) +
  coord_cartesian(ylim = c(0, 4500)) +
  scale_y_continuous(breaks = seq(0, 4500, by = 500), labels = formatC(seq(0, 4500, by = 500), format = "d")) +
  stat_bin(breaks = seq(0, 1, by = 0.025), geom = "text", colour = "black", size = 3, aes(label = ..count..), vjust = 0.3, angle = 80, hjust = -0.4) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "BH-adjusted p-values", y = "Frequency")

ggsave(filename = "./plots_18Q3/crispr/pvals_genes.pdf", plot = wilcox_gene_plot, width = 10, height = 5, device = "pdf")
```
...
```{r fig.height=3, fig.width=6}
wilcox_gene_tissue_plot <- ggplot(data = crispr_signif_tissue, aes(x = p.adj)) +
  geom_histogram(breaks = seq(0, 1, by = 0.025), fill = "darkslateblue", color = "black", alpha = 0.7) +
  scale_x_continuous(breaks = seq(0, 1, by = 0.05), labels = seq(0, 1, by = 0.05)) +
  coord_cartesian(ylim = c(0, 55000)) +
  scale_y_continuous(breaks = seq(0, 55000, by = 5000), labels = formatC(seq(0, 55000, by = 5000), format = "d")) +
  stat_bin(breaks = seq(0, 1, by = 0.025), geom = "text", colour = "black", size = 3, aes(label = ..count..), vjust = 0.3, angle = 80, hjust = -0.4) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "BH-adjusted p-values", y = "Frequency")

ggsave(filename = "./plots_18Q3/crispr/pvals_genes_tissues.pdf", plot = wilcox_gene_tissue_plot, width = 10, height = 5, device = "pdf")
```
