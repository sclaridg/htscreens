...
drug_data$Hugo_Symbol <- factor(drug_data$Hugo_Symbol)

saveRDS(drug_data, "./data_munging/drug_data_18Q3.rds", compress = "xz")
```

```{r}
drug_data <- readRDS("./data_munging/drug_data_18Q3.rds")
```
