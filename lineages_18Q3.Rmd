...
# autoplot(crispr_pca, data = crispr_pca_data, color = "group_general_lineage_name")
summary(crispr_pca)
...
genes_lvlA <- c("ABL1", "ALK", "AR", "ATM", "BRAF", "BRCA1", "BRCA2", "CDKN2A", "DNMT3A", "DPYD", "EGFR", "ERBB2", "ERBB3", "FGFR2", "FLT3", "JAK2", "KIT", "KRAS", "MET", "NOTCH1", "NOTCH2", "NRAS", "PDGFRA", "PDGFRB", "PIK3CA", "PML", "PTCH1", "RET", "ROS1", "SF3B1", "SMO", "TP53", "TSC1")
...
crispr_ptmuts_lvlA_color <- as.character(crispr_ptmuts_lvlA$Color_Nonsilent)
names(crispr_ptmuts_lvlA_color) <- crispr_ptmuts_lvlA$Mutation_Status_Nonsilent

label_text <- data.frame(p.signif.adj = crispr_signif_nonsilent$p.signif.adj, Hugo_Symbol = crispr_signif_nonsilent$Hugo_Symbol)
label_text <- filter(label_text, Hugo_Symbol %in% genes_lvlA)
label_text$Hugo_Symbol <- factor(label_text$Hugo_Symbol, levels = genes_lvlA)
...
# ggsave("./plots_18Q3/manuscript/crispr_ptmuts_lvlA_plot.png", crispr_ptmuts_lvlA_plot, device = "png", width = 20, height = 5, units = "in")

crispr_ptmuts_lvlA_plot_faceted <- ggplot(data = crispr_ptmuts_lvlA, aes(x = Mutation_Status_Nonsilent, y = Score)) +
...
# ggsave("./plots_18Q3/manuscript/crispr_ptmuts_lvlA_plot_faceted.png", crispr_ptmuts_lvlA_plot_faceted, device = "png", width = 20, height = 5, units = "in")

crispr_ptmuts_lvlA_plot_faceted_truncated <- ggplot(data = crispr_ptmuts_lvlA, aes(x = Mutation_Status_Nonsilent, y = Score)) +
  facet_wrap(~ Hugo_Symbol, ncol = length(unique(crispr_ptmuts_lvlA$Hugo_Symbol))) +
  geom_hline(yintercept = 0, lty = 2, color = "darkgray") +
  ...
  labs(fill = "Mutation Status", y = "CERES Score", x = "Mutation Status")
crispr_ptmuts_lvlA_plot_faceted_truncated
# ggsave("./plots_18Q3/manuscript/crispr_ptmuts_lvlA_plot_faceted_truncated.png", crispr_ptmuts_lvlA_plot_faceted_truncated, device = "png", width = 20, height = 5, units = "in")
```
