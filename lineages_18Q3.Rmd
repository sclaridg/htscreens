...
chm_ge_plot <- Heatmap(chm_ge, name = "Gene Expression (RPKM)",
        ...
        column_title_gp = gpar(fontsize = 60, fontface = "bold"),
        column_order = colnames(chm_scores)[unlist(column_order(chm_scores_plot))],
        row_order = rownames(chm_scores)[unlist(row_order(chm_scores_plot))],
        width = 1)
...
pdf("./plots_18Q3/crispr_heatmap_all.pdf", width = 100, height = 100, paper = "special") 
