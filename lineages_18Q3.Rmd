...
chm_plot_cols <- colnames(chm_scores)[unlist(column_order(chm_scores_plot))]
chm_plot_rows <- rownames(chm_scores)[unlist(row_order(chm_scores_plot))]

chm_ge_plot <- Heatmap(chm_ge, name = "Gene Expression (RPKM)",
        na_col = "black",
        ...
        width = 1)
chm_cn_plot <- Heatmap(chm_cn, name = "Copy Number",
        na_col = "black",
        cluster_rows = FALSE, cluster_columns = FALSE,
        show_row_names = FALSE, show_column_names = FALSE,
        ...
        row_order = chm_plot_rows,
        width = 1)
chm_mut_plot <- Heatmap(chm_mut, name = "Mutation Status",
        na_col = "black",
...
# chm_all_plot <- chm_scores_plot + chm_ge_plot + chm_cn_plot + chm_mut_plot
#   
# pdf("./../crispr_lineages_giant_files/crispr_heatmap_all.pdf", width = 100, height = 100, paper = "special") 
...
# pdf("./../crispr_lineages_giant_files/crispr_heatmap_ge.pdf", width = 100, height = 100, paper = "special") 
# draw(chm_scores_plot + chm_ge_plot, heatmap_legend_side = "right", annotation_legend_side = "right")
# seekViewport("annotation_Cell_Line_SSMD")
# grid.text("Cell Line SSMD", unit(1, "npc") + unit(2, "mm"), 0.5, gp = gpar(fontsize = 30), default.units = "npc", just = "left")
# seekViewport("annotation_Cas9_Activity")
# grid.text("Cas9 Activity", unit(1, "npc") + unit(2, "mm"), 0.5, gp = gpar(fontsize = 30), default.units = "npc", just = "left")
...
pdf("./../crispr_lineages_giant_files/crispr_heatmap_mut.pdf", width = 100, height = 100, paper = "special") 
draw(chm_scores_plot + chm_mut_plot, heatmap_legend_side = "right", annotation_legend_side = "right")
seekViewport("annotation_Cell_Line_SSMD")
grid.text("Cell Line SSMD", unit(1, "npc") + unit(2, "mm"), 0.5, gp = gpar(fontsize = 30), default.units = "npc", just = "left")
seekViewport("annotation_Cas9_Activity")
grid.text("Cas9 Activity", unit(1, "npc") + unit(2, "mm"), 0.5, gp = gpar(fontsize = 30), default.units = "npc", just = "left")
...
pdf("./../crispr_lineages_giant_files/crispr_heatmap_cn.pdf", width = 100, height = 100, paper = "special") 
draw(chm_scores_plot + chm_cn_plot, heatmap_legend_side = "right", annotation_legend_side = "right")
seekViewport("annotation_Cell_Line_SSMD")
grid.text("Cell Line SSMD", unit(1, "npc") + unit(2, "mm"), 0.5, gp = gpar(fontsize = 30), default.units = "npc", just = "left")
seekViewport("annotation_Cas9_Activity")
grid.text("Cas9 Activity", unit(1, "npc") + unit(2, "mm"), 0.5, gp = gpar(fontsize = 30), default.units = "npc", just = "left")
