...
png("./pozdeyev_unmatched/venn_pgx_crispr_overlap.png", res = 500, units = "in", width = 6, height = 6)
grid.newpage()
...
png("./pozdeyev_unmatched/venn_ccl_overlap.png", res = 500, units = "in", width = 6, height = 6)
grid.newpage()
...
png("./pozdeyev_unmatched/venn_omics_overlap.png", res = 500, units = "in", width = 6, height = 6)
grid.newpage()
...
bar_ccl_per_hist
ggsave("./pozdeyev_unmatched/barplot_ccl_per_histology.png", bar_ccl_per_hist, device = "png", dpi = 450, width = 12, height = 6, units = "in")
...
png("./pozdeyev_unmatched/venn_drugs_overlap.png", res = 500, units = "in", width = 6, height = 6)
grid.newpage()
...
ggsave("./pozdeyev_unmatched/barplot_ccl_per_histology_per_db.png", bar_ccl_per_hist_per_db, device = "png", dpi = 450, width = 12, height = 8, units = "in")
...
bar_ccl_per_hist <- ggplot(data = unique(select(auc_all, Cell_line, Histology))) +
  ...
  theme(axis.text.x = element_text(angle = 60, hjust = 1))
bar_ccl_per_hist
ggsave("./pozdeyev_unmatched/barplot_ccl_per_histology.png", bar_ccl_per_hist, device = "png", dpi = 450, width = 12, height = 8, units = "in")
...
ggsave("./pozdeyev_unmatched/histogram_aucic50_per_db.png", histo_aucic50_per_db, device = "png", dpi = 450, width = 12, height = 6, units = "in")
```
