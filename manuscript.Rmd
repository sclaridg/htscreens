...
knitr::kable(ccle_data_allgenes[, c("Hugo_Symbol", "Drug", "p", "p.adj", "p.format", "p.signif", "p.signif.adj")], caption = "CCLE: by-drug Wilcoxon test results for point mutations in genes targeted in CRISPR screen (* p <= 0.05, ** p <= 0.01, *** p <= 0.001, **** p <= 0.0001)") %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>% scroll_box(width = "900px", height = "450px")
```
...
knitr::kable(gdsc_data_allgenes[, c("Hugo_Symbol", "Drug", "p", "p.adj", "p.format", "p.signif", "p.signif.adj")], caption = "GDSC: by-drug Wilcoxon test results for point mutations in genes targeted in CRISPR screen (* p <= 0.05, ** p <= 0.01, *** p <= 0.001, **** p <= 0.0001)") %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>% scroll_box(width = "900px", height = "450px")
```
...
g2p_druggene_p_summ <- g2p %>% group_by(Drug_Gene) %>% tally()
g2p_druggene_p_summ <- merge(g2p_druggene_p_summ, ccle_signif_g2p[, c("Drug_Gene", "p")], by = "Drug_Gene", all.x = TRUE)
...
# ggsave("./plots_18Q3/manuscript/g2p_druggene_p_summ_plot", g2p_druggene_p_summ_plot.png, device = "png", dpi = 450, width = 8, height = 4, units = "in")
```
