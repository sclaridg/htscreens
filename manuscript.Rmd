...
ccle_cor_res <- ccle_data_g2p_grid %>% group_by(Drug_Gene) %>%
                    summarize(Pearson_Corr_GE = cor.test(y = AUC, x = RPKM, method = "pearson", use = "complete.obs")$estimate,
                              ...
                              Spearman_Corr_GE = cor.test(y = AUC, x = RPKM, method = "spearman", use = "complete.obs")$estimate,
                              Spearman_Pval_GE = cor.test(y = AUC, x = RPKM, method = "spearman", use = "complete.obs")$p.value,
                              Spearman_Corr_CN = cor.test(y = AUC, x = CN, method = "spearman", use = "complete.obs")$estimate,
                              Spearman_Pval_CN = cor.test(y = AUC, x = CN, method = "spearman", use = "complete.obs")$p.value)
ccle_cor_res <- merge(g2p_druggene_p_tally, ccle_cor_res, by = "Drug_Gene", all.y = TRUE)
...
ctrp_cor_res <- ctrp_data_g2p_grid %>% group_by(Drug_Gene) %>%
                    summarize(Pearson_Corr_GE = cor.test(y = AUC, x = RPKM, method = "pearson", use = "complete.obs")$estimate,
                              ...
                              Spearman_Corr_CN = cor.test(y = AUC, x = CN, method = "spearman", use = "complete.obs")$estimate,
                              Spearman_Pval_CN = cor.test(y = AUC, x = CN, method = "spearman", use = "complete.obs")$p.value)
ctrp_cor_res <- merge(g2p_druggene_p_tally, ctrp_cor_res, by = "Drug_Gene", all.y = TRUE)
...
gdsc_cor_res <- gdsc_data_g2p_grid %>% group_by(Drug_Gene) %>%
                    summarize(Pearson_Corr_GE = cor.test(y = AUC, x = RPKM, method = "pearson", use = "complete.obs")$estimate,
                              ...
                              Spearman_Corr_CN = cor.test(y = AUC, x = CN, method = "spearman", use = "complete.obs")$estimate,
                              Spearman_Pval_CN = cor.test(y = AUC, x = CN, method = "spearman", use = "complete.obs")$p.value)
gdsc_cor_res <- merge(g2p_druggene_p_tally, gdsc_cor_res, by = "Drug_Gene", all.y = TRUE)
...
g2p_mut_summ <- merge(g2p_druggene_p_tally, ccle_signif_g2p_grid[, c("Drug_Gene", "p")], by = "Drug_Gene", all.x = TRUE)
g2p_mut_summ <- merge(g2p_mut_summ, ctrp_signif_g2p_grid[, c("Drug_Gene", "p")], by = "Drug_Gene", all.x = TRUE, suffixes = c("_CCLE", "_CTRP"))
g2p_mut_summ <- merge(g2p_mut_summ, gdsc_signif_g2p_grid[, c("Drug_Gene", "p")], by = "Drug_Gene", all.x = TRUE)
colnames(g2p_mut_summ)[colnames(g2p_mut_summ) == "p_CCLE"] <- "CCLE"
colnames(g2p_mut_summ)[colnames(g2p_mut_summ) == "p_CTRP"] <- "CTRP"
colnames(g2p_mut_summ)[colnames(g2p_mut_summ) == "p"] <- "GDSC"

g2p_mut_summ_melt <- melt(g2p_mut_summ, id.vars = c("Drug_Gene", "n"), measure.vars = c("CCLE", "CTRP", "GDSC"), variable.name = "Dataset", value.name = "p")

g2p_mut_summ_plot <- ggplot(data = g2p_mut_summ_melt, aes(x = p, y = n, shape = Dataset, color = Dataset)) +
  geom_point(size = 2) +
...
g2p_mut_summ_plot
# ggsave("./plots/manuscript/g2p_mut_summ_plot.png", g2p_mut_summ_plot, device = "png", dpi = 450, width = 8, height = 4, units = "in")
```
...
```{r}
ccle_mut_summ <- merge(g2p_druggene_p_tally, ccle_signif_g2p_grid[, c("Drug_Gene", "p")], by = "Drug_Gene", all = TRUE)
...
ctrp_mut_summ <- merge(g2p_druggene_p_tally, ctrp_signif_g2p_grid[, c("Drug_Gene", "p")], by = "Drug_Gene", all = TRUE)
...
gdsc_mut_summ <- merge(g2p_druggene_p_tally, gdsc_signif_g2p_grid[, c("Drug_Gene", "p")], by = "Drug_Gene", all = TRUE)
...
### Genomic features supplementary plots
...
all_mut_summ_plot <- ggplot(data = subset(all_res_mut, p < 0.05)) +
  facet_grid(~ Dataset) +
...
g2p_mut_cor_stats <- g2p_mut_cor
g2p_mut_cor_stats$n_true <- TRUE
g2p_mut_cor_stats <- g2p_mut_cor_stats %>% group_by(Dataset, InG2P) %>% drop_na() %>% summarize(
...
# ggsave("./plots/manuscript/all_dgl_ttest_summ_plot.png", ttest_summ_plot, device = "png", dpi = 450, width = 12, height = 7, units = "in")
```
