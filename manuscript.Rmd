...
PearsonByLineage <- function(lin, dataset) {
  ...
  use_data_summ <- filter(use_data_summ, n >= 3)
...
GexpPlotlyByLineage <- function(lineage) {
  ...
  plot <- subplot(plot_box, plot_point, nrows = 2, titleX = TRUE, titleY = TRUE) %>% layout(title = lineage, margin = list(t = 75, l = 75), xaxis5 = list(title = "Pearson correlation coefficient between gene-drug AUC and gene expression"), yaxis = list(title = "Level A G2P\nassociation", domain = c(0.8, 1)), yaxis2 = list(title = "Number of level A G2P associations", domain = c(0, 0.79)))
...
ccle_signif_g2p_ByDrug <- lapply(unique(ccle_data_g2p_genesfilt$Drug), WilcoxonByDrug, dataset = ccle_data_g2p_genesfilt, data_name = "ccle", grouping_var = "gene")
...
```{r, eval=FALSE}
ccle_signif_g2p_lineage <- lapply(unique(ccle_data_g2p_genesfilt$Drug), WilcoxonByDrug, dataset = ccle_data_g2p_genesfilt, data_name = "ccle", grouping_var = "lineage")
...
ctrp_signif_g2p_ByDrug <- lapply(unique(ctrp_data_g2p_genesfilt$Drug), WilcoxonByDrug, dataset = ctrp_data_g2p_genesfilt, data_name = "CTRP", grouping_var = "gene")
...
```{r, eval=FALSE}
ctrp_signif_g2p_lineage <- lapply(unique(ctrp_data_g2p_genesfilt$Drug), WilcoxonByDrug, dataset = ctrp_data_g2p_genesfilt, data_name = "ctrp", grouping_var = "lineage")
...
gdsc_signif_g2p_ByDrug <- lapply(unique(gdsc_data_g2p_genesfilt$Drug), WilcoxonByDrug, dataset = gdsc_data_g2p_genesfilt, data_name = "gdsc", grouping_var = "gene")
...
```{r, eval=FALSE}
gdsc_signif_g2p_lineage <- lapply(unique(gdsc_data_g2p_genesfilt$Drug), WilcoxonByDrug, dataset = gdsc_data_g2p_genesfilt, data_name = "gdsc", grouping_var = "lineage")
...
plot_pearson_point <- ggplot(data = g2p_druggene_pearson) +
  ...
  labs(x = "Pearson correlation coefficient between gene-drug AUC and gene expression", y = "Number of level A G2P associations") +
  theme(legend.position = "none", plot.margin = unit(c(0.05, 0.5, 0.5, 0.5), "cm"), strip.background = element_blank(), strip.text.x = element_blank())
...
plot <- subplot(plot_pearson_box, plot_pearson_point, nrows = 2, titleX = TRUE, titleY = TRUE) %>% layout(margin = list(l = 75), xaxis5 = list(title = "Pearson correlation coefficient between gene-drug AUC and gene expression"), yaxis = list(title = "Level A G2P\nassociation", domain = c(0.8, 1)), yaxis2 = list(title = "Number of level A G2P associations", domain = c(0, 0.79)))
